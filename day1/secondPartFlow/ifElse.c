...
int main(){
    int a,b,c,d; // deklarasi variabel a,b,c,d
    a = 20, b =30; // inisialisasi variabel a dan b
    printf("enter the value of c = "); // mencetak "enter the value of c = "
    scanf("%d",&c); // meminta input dari console dan menyimpannya ke variabel c
    ...
    ///*
    printf("assume c represents which day of the week\nc is "); // mencetak "assume c represents which day of the week\nc is "
    switch (c) // switch case yang mengevaluasi nilai dari c dan mencetak hari dalam seminggu sesuai dengan nilai c
    {
    case 1:
        printf("Monday");
        break;
