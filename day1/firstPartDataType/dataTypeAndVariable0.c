...
int main()
{
    ...
    float floatValue = 23.4f; // deklarasi float
    float floatValue1 = 20; // deklarasi float
    float floatValue2 = 30; // deklarasi float

    float dividedValue; // deklarasi float

    printf("%f", floatValue); // mencetak floatvalue
    dividedValue = floatValue1/floatValue2; // membagi floatvalue1 dengan floatvalue2
    printf("\n%.2f",dividedValue); // mencetak hasil pembagian dengan 2 angka di belakang koma
